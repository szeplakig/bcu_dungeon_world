When generating a steading, you can use the [Location Builder](Location%20Builder.md) for a randomised starting point. See also: [Steading templates](Steading%20templates.md)
